...
## one-sentence role
Validates gates, proof, review, risks, rollback, approvals, and emits sealed/failed/blocked.

## natural-language activation triggers
Use SEAL when the corridor reaches seal responsibilities or when validating that phase evidence.
...
A medium-risk validator change enters SEAL; the Skill reads the shift, records phase evidence, refuses deployment authority, and chains out to RECEIPT.
